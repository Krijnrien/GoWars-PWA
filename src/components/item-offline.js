...
class ItemOffline extends LitElement {
  _render() {
    return html`
      ${BookButtonStyle}
      <style>
      ...
      <section>
        ...
        <button class="item-button" on-click="${() => this._refresh()}">Try Again...</button>
      </section>
    `;
  }
...
window.customElements.define('item-offline', ItemOffline);
